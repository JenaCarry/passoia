...
export function Lancamentos() {
    ...
    return (
        <section id="lancamentos" className="lancamentos">
            ...
            <div className="lancamentos__container">
                ...
                <div className="lancamentos__right">
                    ...
                    <div className="lancamentos__description">
                        ...
                        <p className="lancamentos__description-text">
                            O Batom Matte possui uma fórmula inovadora
                            desenvolvida para entregar o máximo de cor na
                            primeira aplicação com um deslize suave e macio. Tem
                            acabamento matte aveludado e manteiga de manga que
                            ajuda a hidratar e a proteger os lábios contra
                            ressecamento. Ajuda na hidratação dos lábios,
